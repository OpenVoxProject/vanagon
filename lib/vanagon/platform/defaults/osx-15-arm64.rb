platform 'osx-15-arm64' do |plat|
    ...
    plat.provision_with %Q(sudo su test -c 'echo | /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)"') unless File.directory?('/opt/homebrew')
    plat.provision_with 'sudo chown -R test /opt/homebrew'
